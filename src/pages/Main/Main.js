	...
	{/* Header with icon, text and two buttons  */}
		<nav className="navbar navbar-light bg-light">
			<span className="navbar-brand mb-0 px-0 h1">
				<img src="images/sun.icon.gif" width="30" height="30" className="d-inline-block align-top" alt="sun icon"></img>	
					SUNNY WALK</span>
						<div className="col-sm-1 col-xs-1 col-md-1 col-lg-1"></div>
							<div className="d-flex justify-content-end">
								<div style={{ padding: 18 }}>
									<Button variant="outlined" className="primary" href="../Home" alt="Home button, blue" my={1} px={2} >
										Log In
									</Button>
									<Button variant="" color="link" href="../Register" alt="Register button, blue" my={1} px={2} >
										Sign Up
									</Button>	
								</div>
							</div>
			...
			<header className="major"  >
				<nav className="navbar navbar-light bg-light">
					<h3 style={{ color: '#985b9c' }}>Sunny Walks at your fingertips</h3>
						<p>Find the best time to take a daily walk, enjoy the sun outdoors and pursue your happiness.</p>
					...
					<div className="row">
						<div className="6u">
							<section className="special">
								<div className="image fit"><img src="images/pic10.cityfamily.jpg" alt="Woman and child of color, smiling sweetly at camera, woman wearing leather clothes kneeling with gender neutral child hugging her shoulders, backdrop of center city, brick street" /></div>
			...
			<section id="three" className="wrapper style1">
				<div className="container">
					<div className="row">
						<div className="6u">
							<section className="special">
								<div className="image fit"><img src="images/pic05.funwheelchair.jpg" alt="distant picture of person pushing another in wheelchair against architectual building and waterfront" /></div>
			...
			<section id="three" className="wrapper style3">
				<div className="container">
					<div className="row">
						<div className="8u">
							<section>
								<div className="image fit"><img src="images/pic02.jpg" alt="Woman of colour wearing backpack walking solo against industrial style city wall" /></div>
									<h2>Sunshine everywhere</h2>
										<p>Create and discover new routes. Your next adventure begins now.</p>
							</section>
						</div>
						<div className="4u">
							<section>
